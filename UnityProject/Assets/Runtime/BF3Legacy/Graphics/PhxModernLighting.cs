...
public class PhxModernLighting : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        ssr.minSmoothness.Override(0.6f);
        ...
        // --- Volumetric fog: light shafts in hangars, dusty battlefields ---
        ...
        // --- Subtle film grain-free color tweak: slightly lifted contrast ---
        ...
        Volume.priority = 100f; // win over per-map volumes loaded from level data
